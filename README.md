...
genetic sequences through the use of vector similarity models. This facilitates a better understanding of how certain regions of DNA can influence gene activity. I designed my system to be user-friendly, providing clear and accessible explanations of intricate genetic information.
...
Large Language Models (LLMs) are integrated into the application to interpret and process user inputs and genetic data. My custom-trained model understands data structured into chromosomal frequencies and methylated data values paired with nitrogen bases.
