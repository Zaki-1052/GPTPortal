...
let currentModelID;
let fileSessionId = null;  // Add this with your other global variables
    ...
    // Functions for handling image input files
      ...
      async function uploadFile(file) {
        ...
        try {
          ...
          if (data.sessionId) {
            fileSessionId = data.sessionId;  // Define this at a scope accessible to sendMessageToServer
          }
      ...
      async function sendMessageToServer(message) {    
        ...
        if (currentModelID.includes('gemini')) {
          ...
          payload = {
            ...
            file: fileUrl,
            sessionId: fileSessionId, // Add this line to include the sessionId
            temperature: temperature
          };
