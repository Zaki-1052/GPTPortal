...
export declare class Responses extends APIResource {
     ...
     * ```
     */
    retrieve(responseId: string, query?: ResponseRetrieveParamsNonStreaming, options?: Core.RequestOptions): Core.APIPromise<Response>;
    retrieve(responseId: string, query?: ResponseRetrieveParamsStreaming, options?: Core.RequestOptions): Core.APIPromise<Stream<ResponseStreamEvent>>;
    retrieve(responseId: string, options?: Core.RequestOptions): Core.APIPromise<Response>;
    retrieve(responseId: string, query: ResponseRetrieveParams | Core.RequestOptions, options?: Core.RequestOptions): Core.APIPromise<Response> | Core.APIPromise<Stream<ResponseStreamEvent>>;
    /**
